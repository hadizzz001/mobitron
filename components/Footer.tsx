                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myGray">
                                    All rights reserved © {(new Date().getFullYear())} mobitron
                                </span>
                            </div>
                        </div>
                    </div>
